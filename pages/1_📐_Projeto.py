...
def gerar_pdf(projeto):
    ...
    dados_orcamento = [
        [
            Paragraph(
                f"<b>Projeto:</b><br/>"
                f"{nome_projeto or 'Não informado'}",
                estilo_normal,
            ),
            Paragraph(
                f"<b>Cliente:</b><br/>"
                f"{cliente or 'Não informado'}",
                estilo_normal,
            ),
        ],
        [
    ...
    elementos.append(
        KeepTogether(
            materiais_secao + [tabela_material_pdf]
        )
    )
    ...
    elementos.append(
        KeepTogether(
            financeiro_secao + [tabela_financeiro]
        )
    )
    ...
    elementos.append(
        KeepTogether(
            condicoes_secao + [tabela_condicoes]
        )
    )
